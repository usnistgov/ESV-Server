class Entropy_Certify_Payload:

    def __init__(self, entropy_id, entropy_assessments, supporting_documentation, module_id=0, vendor_id=0, entropy_certificate = None):
